    ...
    <div class="flex mb-4 gap-3" >
        ...
        <div class="">
            ...
            <div>
                ...
                <a wire:click.prevent="startCommentEdit" href="#" class="text-blue-600 mr-3">Edit</a>
                <a wire:click.prevent="deleteComment" href="#"  class="text-red-600 mr-3">Delete</a>
                @endif
            </div>
            @if ($reply)
            ...
            @if ($comment->comments->count())
                <div class="mt-4">
                    @foreach ($comment->comments as $childComment)
                        <livewire:comment-item :comment="$childComment" wire:key="comment-{{ $comment->id }}" />
                    @endforeach
